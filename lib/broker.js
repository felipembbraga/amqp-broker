...
exports.Broker = exports.defaultConfig = void 0;
    ...
    function Broker(_config) {
        ...
        this.connect = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!!this._connection) return [3 /*break*/, 9];
                    ...
                    case 1:
                        _c.trys.push([1, 6, , 9]);
                        this._logger.info("[connect] going to connect to " + this._config.connection.host + ":" + this._config.connection.port);
                        _a = this;
                    ...
                    case 2:
                        ...
                        this._connection.on("error", function (err) {
                            ...
                            if (err.message !== "connection closing") {
                                _this._logger.error("Conn error: ", err.message);
                            }
                            else {
                                _this._logger.info("[connect] reconnecting ..");
                            }
                            setTimeout(_this.init, 1000);
                        });
                        this._connection.on("close", function () {
                            _this._connection = undefined;
                            _this._logger.info("[connect] Connection closed!");
                            _this._logger.info("[connect] reconnecting ..");
                            // Try to reconnect
                            setTimeout(_this.init, 1000);
                        });
                        this._logger.info("[connect] connected to " + this._config.connection.host + ":" + this._config.connection.port + " is ok!");
                        // Save the channel
                        _b = this;
                    ...
                    case 6:
                        e_1 = _c.sent();
                        this._logger.error("Error trying to connect to " + url, e_1);
                    ...
                    case 9: return [2 /*return*/, this._connection];
                }
            });
        }); };
        /**
        ...
        this.init = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(this._exchanges.map(function (ex) {
                                if (_this._channel) {
                                    ...
                                    _this._logger.info("[exchange] init exchange " + ex.name + ".");
                                }
                            }))];
                    case 3:
                        _b.sent();
                    ...
                    case 4:
                        e_2 = _b.sent();
                        this._logger.error(e_2.message, e_2);
                        return [3 /*break*/, 5];
                    case 5:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this._channel.consume(queue.queue, this._consumes.get(queue.queue), q.options)];
                    case 4:
                        _a.sent();
        ...
        this._logger = logger_1.factoryLogger(this._config.connection.name, {
            level: "info",
                    ...
                    case 2:
                        ...
                        if (this._channel) {
                            ...
                            if (msg.properties.replyTo) {
                                this._logger.info("[consumer] Replying to " + msg.properties.replyTo + ".");
