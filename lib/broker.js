...
var Broker = /** @class */ (function () {
    ...
    function Broker(_config) {
        ...
        this._connection = null; // Conexão com o Rabbitmq
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        exports.logger.info("Creating queue " + q.name);
                    ...
                    case 4:
                        _a.sent();
                        exports.logger.info("initQueue: consume - " + q.key + " is ok");
                        return [2 /*return*/];
                }
            });
        }); };
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (this._connection !== null) {
                            exports.logger.info("[connect] your broker is already connected.");
                            return [2 /*return*/];
                        }
                    ...
                    case 3:
                        ...
                        this._connection.on("error", function (err) {
                            ...
                            if (err.message !== "connection closing") {
                                exports.logger.error("Conn error: ", err.message);
                            }
                        });
                        this._connection.on("close", function () {
                            _this._connection = null;
                            exports.logger.error("Connection closed!");
                            exports.logger.error("reconnecting ..");
                    ...
                    case 4:
                        e_1 = _c.sent();
                        exports.logger.error("Error trying to connection to " + url);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        exports.logger.info("Connection is closed!");
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 6];
                    case 9:
                        exports.logger.info("Initialization is done");
                        return [2 /*return*/];
                }
            });
        });
    ...
    Broker.prototype.addConsume = function (queue, cb) {
        ...
        this._consumes.set(queue, function (msg) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.logger.info("Running consumer " + queue);
                    ...
                    case 1:
                        ...
                        if (this._channel) {
                            ...
                            if (msg.properties.replyTo) {
                                exports.logger.info("Replying to " + msg.properties.replyTo);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6: return [2 /*return*/, response.content.toString()];
                }
            });
        });
    };
