...
var Broker = /** @class */ (function () {
    ...
    function Broker(_config) {
                    ...
                    case 2:
                        ...
                        this._connection.on("error", function (err) {
                            ...
                            if (err.message !== "connection closing") {
                                ...
                                _this._logger.info("reconnecting ..");
                            }
                            setTimeout(_this.init, 1000);
                        });
                        this._connection.on("close", function () {
                            _this._connection = undefined;
                            _this._logger.info("Connection closed!");
                            _this._logger.info("reconnecting ..");
                            // Try to reconnect
                            setTimeout(_this.init, 1000);
                        });
        ...
        this._logger = logger_1.factoryLogger({
            level: "info",
        ...
        this._consumes.set(queue, function (msg) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("teste");
                        this._logger.info(function () { return "Running consumer " + queue; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._logger.info(function () { return "Publishing to " + publishOptions.key + "..."; });
                        // publish the message
